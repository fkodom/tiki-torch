...
def recall(
    ...
    r"""Computes recall for a PIR detector, given detection locations, target
    locations, and a PCBS datacube.
...
def precision(
    ...
    r"""Computes precision for a PIR detector, given detection locations, target
    locations, and a PCBS datacube.
...
def get_detection_statistics(
    ...
    r"""Computes statistics for a PIR detector, given detection locations, target
    locations, and a PCBS datacube.
...
def get_algorithm_statistics(
    ...
    r"""Computes detection statistics for a PIR detection algorithm over a complete
